...
Projeto de portfólio que demonstra uma estratégia de QA completa sobre a API ServeRest, combinando testes de API, testes E2E e uma camada de ferramentas de IA para geração, revisão e triagem de testes.
